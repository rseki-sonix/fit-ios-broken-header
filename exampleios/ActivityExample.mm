...
- (FIT_UINT8)encode
{
    ...
    // MARK:- Write Device Information
    fit::DeviceInfoMesg deviceInfo;
    FIT_WSTRING name = L"0000000000111111111122222222223333333333444444444455555555556666666666777777777788888888889999999999aaaaaaaaaabbbbbbbbbbcccccccccc";
    deviceInfo.SetProductName(name);
    deviceInfo.SetDescriptor(name);
